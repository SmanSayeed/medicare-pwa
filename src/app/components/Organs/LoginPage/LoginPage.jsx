        ...
        <div className="custom-container">
          <div className="register-form mt-4">
            ...
            <form onSubmit={handleSubmit(handleLogin)}>
              <InputField type="text" id="mobile" placeholder="Mobile Number" name="email" className="form-control" register={register} error={errors.email} />
              <PasswordInput type="password" id="password" placeholder="Password" name="password" className="form-control" register={register} error={errors.password} />
